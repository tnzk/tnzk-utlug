...
int main(int argc, char** argv)
{
  ...
  cvmSet( kernel, 0, 0, 0.0);
  cvmSet( kernel, 0, 1, 0.0);
  cvmSet( kernel, 0, 2, 0.0);
  cvmSet( kernel, 1, 0, 0.0);
  cvmSet( kernel, 1, 1, 1.0);
  cvmSet( kernel, 1, 2, 0.0);
  cvmSet( kernel, 2, 0, 0.0);
  cvmSet( kernel, 2, 1, 0.0);
  cvmSet( kernel, 2, 2, 0.0);
